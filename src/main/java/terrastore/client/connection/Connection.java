...
public interface Connection {
	 ...
	 * @throws TerrastoreClientException If the server returns a failure response.
	 */
	...
	/**
	 * Put/store a value in a bucket, under a key as specified by a KeyOperation.
	 * 
	 ...
	 * @throws TerrastoreClientException If the server returns a failure response.
	 */
	<T> void putValue(KeyOperation key, T value) throws TerrastoreClientException;
	...
	/**
	 * Gets the stored value for a key, as an instance of the specified Java type.
	 * 
	 ...
	 * @throws TerrastoreClientException If the server returns a failure response 
	 * 			or if the specified bucket/key does not exist.
	 */
	<T> T getValue(KeyOperation key, Class<T> type) throws TerrastoreClientException;
	 ...
	 * @throws TerrastoreClientException if the server returns a failure response, 
	 * 			or if the specified bucket does not exist.
	 */
	<T> Map<String, T> getAllValues(BucketOperation bucket, Class<T> type) throws TerrastoreClientException;
	 ...
	 */
	<T> Values<T> doRangeQuery(RangeQuery query, Class<T> type) throws TerrastoreClientException;
	 ...
	 * @throws TerrastoreClientException
	 */
	<T> Values<T> doPredicateQuery(PredicateQuery query, Class<T> type) throws TerrastoreClientException;
